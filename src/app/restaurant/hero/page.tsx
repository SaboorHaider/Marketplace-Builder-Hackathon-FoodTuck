  ...
  return (
    ...
    <div className="items-center justify-center mr-10 hidden sm:block md:block">
      <div className="flex flex-col items-center text-white space-y-8 ">
        ...
        <Link href="https://www.facebook.com/SaboorHaider110/" className="text-white hover:text-blue-700">
          <FaFacebookF />

        </Link>
        <Link href="https://www.linkedin.com/in/abdul-saboor-b57043288/" className="text-white hover:text-blue-500">
          <FaLinkedinIn />
        </Link>

        <Link href="https://github.com/SaboorHaider" className="text-white hover:text-gray-700">
          <FaGithub />
        </Link>
